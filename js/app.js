(() => {
  ...
  const w = {
    ...
    is: function (e) {
      ...
      if ("string" == typeof e) {
        ...
        for (n = m(e), a = 0; a < n.length; a += 1) if (n[a] === i) return !0;
        return !1;
      }
      if (e === s) return i === s;
      if (e === t) return i === t;
          ...
          void 0 !== n &&
            ...
            (T(t[i]) && T(a[i])
              ? a[i].__swiper__
                ...
                : E(t[i], a[i])
              : !T(t[i]) && T(a[i])
              ? ((t[i] = {}), a[i].__swiper__ ? (t[i] = a[i]) : E(t[i], a[i]))
              : (t[i] = a[i]));
        }
      }
    }
  ...
  function le({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function c() {
      ...
      if ("bullets" === t.type) {
        ...
        n.html(a), (e.pagination.bullets = n.find(re(t.bulletClass)));
      }
      "fraction" === t.type &&
        ((a = t.renderFraction
  ...
  const ce = document.querySelectorAll("._anim-items");
  if (ce.length > 0) {
    function e() {
